...
<h2 class="appcard__title">OpenMapTiles Mobile Demo App</h2>

<p class="appcard__text">
To see OpenMapTiles in action on a mobile device, check out our pre-built demo app. It showcases online vector maps hosted on standard web servers and offline maps directly embedded in the app as MBTiles packages.
</p>

<p class="appcard__text appcard__text--tight">
Experience online & offline OpenStreetMap vector tiles designed with MapTiler and stored in a highly-compressed, offline-ready format.
</p>

<p class="appcard__text">
The app demonstrates maps powered by MapLibre loading styles and datasets dynamically, offering a mobile look-and-feel derived from the standard OSM Bright style which can be tailored for any specific use case.
</p>
...
Astro markup used it for the same reason. Renaming it would need the generated
file changed, which would drift on the next extract.
{%- endcomment -%}
<div class="appcard__badges">
<a href="https://play.google.com/store/apps/details?id=com.klokantech.osm2vectortiles" target="_blank" class="appcard__badge-link no-underline">
<img class="appcard__badge" src="/img/mobile/google-play-badge.png" alt="Get it on Google Play" />
</a>
<a href="https://itunes.apple.com/us/app/osm2vectortiles/id1089255502" target="_blank" class="appcard__badge-link no-underline">
<img class="appcard__badge" src="/img/mobile/apple-appstore-badge.png" alt="Download on the App Store" />
</a>
</div>
</div>
<div class="appcard__media">
<img class="appcard__shot" src="/img/mobile/banner_1.png" alt="OpenMapTiles Mobile Demo App Showcase" />
</div>
</div>
</div>
...
<a href="https://docs.maptiler.com/flutter/" class="btn">Read Flutter documentation</a>
