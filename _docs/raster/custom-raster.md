...
We recommend to export map tiles in [MBTiles](https://docs.maptiler.com/hc/en-us/articles/360020806197-How-to-serve-tiles-from-a-folder-MBTiles) format, but folder as an output is also possible.

## Prepare map style

The next step after creating map tiles is to prepare map style suitable for your data. The easy way is to start with [one of existing GL styles](/#map-styles) and [edit it locally with Maputnik](/docs/style/maputnik/).
